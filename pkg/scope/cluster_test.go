...
func TestNewClusterScope_MissingParams(t *testing.T) {
	...
	tests := []struct {
		...
		{"missing client", ClusterScopeParams{Cluster: &clusterv1.Cluster{}, ProxmoxCluster: &infrav2alpha2.ProxmoxCluster{}, ProxmoxClient: &goproxmox.APIClient{}, IPAMHelper: &ipam.Helper{}}},
		{"missing cluster", ClusterScopeParams{Client: k8sClient, ProxmoxCluster: &infrav2alpha2.ProxmoxCluster{}, ProxmoxClient: &goproxmox.APIClient{}, IPAMHelper: &ipam.Helper{}}},
		...
		{"missing ipam helper", ClusterScopeParams{Client: k8sClient, Cluster: &clusterv1.Cluster{}, ProxmoxCluster: &infrav2alpha2.ProxmoxCluster{}, ProxmoxClient: &goproxmox.APIClient{}}},
		{"missing proxmox client", ClusterScopeParams{Client: k8sClient, Cluster: &clusterv1.Cluster{}, ProxmoxCluster: &infrav2alpha2.ProxmoxCluster{}, IPAMHelper: &ipam.Helper{}}},
	}
...
func TestNewClusterScope_MissingProxmoxClient(t *testing.T) {
	...
	proxmoxCluster := &infrav2alpha2.ProxmoxCluster{
		...
		Spec: infrav2alpha2.ProxmoxClusterSpec{
...
func TestListProxmoxMachinesForCluster(t *testing.T) {
	...
	expectedMachineList := &infrav2alpha2.ProxmoxMachineList{
		Items: []infrav2alpha2.ProxmoxMachine{
			{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "machine01",
					Namespace: "default",
	...
	unexpectedMachine := &infrav2alpha2.ProxmoxMachine{
		ObjectMeta: metav1.ObjectMeta{
...
func getFakeClient(t *testing.T) ctrlclient.Client {
	...
	require.NoError(t, err)
	err = infrav2alpha2.AddToScheme(scheme)
	require.NoError(t, err)
