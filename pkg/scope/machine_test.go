...
func TestNewMachineScope_MissingParams(t *testing.T) {
	...
	tests := []struct {
		...
		{"missing client", MachineScopeParams{Cluster: &clusterv1.Cluster{}, Machine: &clusterv1.Machine{}, InfraCluster: &ClusterScope{}, ProxmoxMachine: &infrav2alpha2.ProxmoxMachine{}, IPAMHelper: &ipam.Helper{}}},
		{"missing machine", MachineScopeParams{Client: client, Cluster: &clusterv1.Cluster{}, InfraCluster: &ClusterScope{}, ProxmoxMachine: &infrav2alpha2.ProxmoxMachine{}, IPAMHelper: &ipam.Helper{}}},
		{"missing cluster", MachineScopeParams{Client: client, Machine: &clusterv1.Machine{}, InfraCluster: &ClusterScope{}, ProxmoxMachine: &infrav2alpha2.ProxmoxMachine{}, IPAMHelper: &ipam.Helper{}}},
		...
		{"missing proxmox cluster", MachineScopeParams{Client: client, Cluster: &clusterv1.Cluster{}, Machine: &clusterv1.Machine{}, ProxmoxMachine: &infrav2alpha2.ProxmoxMachine{}, IPAMHelper: &ipam.Helper{}}},
		{"missing ipam helper", MachineScopeParams{Client: client, Cluster: &clusterv1.Cluster{}, Machine: &clusterv1.Machine{}, InfraCluster: &ClusterScope{}, ProxmoxMachine: &infrav2alpha2.ProxmoxMachine{}}},
		{"missing scheme", MachineScopeParams{Client: client, Cluster: &clusterv1.Cluster{}, Machine: &clusterv1.Machine{}, InfraCluster: &ClusterScope{}, ProxmoxMachine: &infrav2alpha2.ProxmoxMachine{}, IPAMHelper: &ipam.Helper{}}},
	}
...
func TestMachineScope_GetProviderID(t *testing.T) {
	p := infrav2alpha2.ProxmoxMachine{
		Spec: infrav2alpha2.ProxmoxMachineSpec{},
	}
	scope := MachineScope{
		ProxmoxMachine: &p,
	}
...
func TestMachineScope_SkipQemuCheckEnabled(t *testing.T) {
	p := infrav2alpha2.ProxmoxMachine{
		Spec: infrav2alpha2.ProxmoxMachineSpec{
			Checks: &infrav2alpha2.ProxmoxMachineChecks{
