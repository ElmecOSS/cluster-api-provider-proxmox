...
func TestReconcileBootstrapData_UpdateStatus(t *testing.T) {
	...
	machineScope.ProxmoxMachine.Spec.Network = &infrav1alpha2.NetworkSpec{
		...
		AdditionalDevices: []infrav1alpha2.AdditionalNetworkDevice{
			{
				NetworkDevice:   infrav1alpha2.NetworkDevice{Bridge: "vmbr1", Model: ptr.To("virtio"), DNSServers: []string{"1.2.3.4"}},
				Name:            "net1",
	...
	vm.VirtualMachineConfig.SMBios1 = biosUUID
	machineScope.SetVirtualMachine(vm)
	machineScope.ProxmoxMachine.Status.IPAddresses = map[string]infrav1alpha2.IPAddress{infrav1alpha2.DefaultNetworkDevice: {IPV4: "10.10.10.10"}, "net1": {IPV4: "10.100.10.10"}}
	createIP4AddressResource(t, kubeClient, machineScope, infrav1alpha2.DefaultNetworkDevice, "10.10.10.10")
...
func TestGetCommonInterfaceConfig_MissingIPPool(t *testing.T) {
	...
	machineScope.ProxmoxMachine.Spec.Network = &infrav1alpha2.NetworkSpec{
		AdditionalDevices: []infrav1alpha2.AdditionalNetworkDevice{
			{
				NetworkDevice: infrav1alpha2.NetworkDevice{Bridge: "vmbr1", Model: ptr.To("virtio"), IPPoolConfig: infrav1alpha2.IPPoolConfig{
...
func TestGetCommonInterfaceConfig_NoIPAddresses(t *testing.T) {
	...
	machineScope.ProxmoxMachine.Spec.Network = &infrav1alpha2.NetworkSpec{
		AdditionalDevices: []infrav1alpha2.AdditionalNetworkDevice{
			{
				NetworkDevice: infrav1alpha2.NetworkDevice{Bridge: "vmbr1", Model: ptr.To("virtio")},
				Name:          "net1",
			},
		},
	}
...
func TestGetCommonInterfaceConfig(t *testing.T) {
	...
	machineScope.ProxmoxMachine.Spec.Network = &infrav1alpha2.NetworkSpec{
		AdditionalDevices: []infrav1alpha2.AdditionalNetworkDevice{
			{
				NetworkDevice: infrav1alpha2.NetworkDevice{Bridge: "vmbr1", Model: ptr.To("virtio"),
					IPPoolConfig: infrav1alpha2.IPPoolConfig{
	...
	vm.VirtualMachineConfig.SMBios1 = biosUUID
	machineScope.SetVirtualMachine(vm)
	machineScope.ProxmoxMachine.Status.IPAddresses = map[string]infrav1alpha2.IPAddress{infrav1alpha2.DefaultNetworkDevice: {IPV4: "10.10.10.10", IPV6: "2001:db8::2"}, "net1": {IPV4: "10.0.0.10", IPV6: "2001:db8::9"}}
...
func TestReconcileBootstrapData_VirtualDevices_VRF(t *testing.T) {
	...
	machineScope.ProxmoxMachine.Spec.Network = &infrav1alpha2.NetworkSpec{
		Default: &infrav1alpha2.NetworkDevice{Bridge: "vmbr0", Model: ptr.To("virtio")},
		VirtualNetworkDevices: infrav1alpha2.VirtualNetworkDevices{
			VRFs: []infrav1alpha2.VRFDevice{{
				Interfaces: []string{"net1"},
				Name:       "vrf-blue",
...
func TestReconcileBootstrapData_DefaultDeviceIPPoolRef(t *testing.T) {
	...
	vm.VirtualMachineConfig.SMBios1 = biosUUID
	machineScope.SetVirtualMachine(vm)
	machineScope.ProxmoxMachine.Status.IPAddresses = map[string]infrav1alpha2.IPAddress{infrav1alpha2.DefaultNetworkDevice: {IPV4: "10.5.10.10"}}
