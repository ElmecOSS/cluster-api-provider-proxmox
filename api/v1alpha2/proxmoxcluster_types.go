...
// Template defines how to select a VM template
type Template struct {
	// SourceNode is the Proxmox node hosting the template
	// +optional
	...
	// TemplateSelector allows selecting templates by tags
	// +optional
...
const (
	...
	ModeSingleInstance Mode = "SingleInstance"

	ModeMultiInstance Mode = "MultiInstance"
)

// ProxmoxClusterSettings defines the cluster settings
type ProxmoxClusterSettings struct {
	// Mode defines the cluster operation mode
	Mode Mode `json:"mode,omitempty"`

	// Instances defines cluster instance configurations
	Instances []ProxmoxClusterInstance `json:"instances,omitempty"`
}

// ProxmoxClusterInstance defines a Proxmox cluster instance configuration
type ProxmoxClusterInstance struct {
	// Name of the instance
	Name string `json:"name"`

	// Nodes available for this instance
	Nodes []string `json:"nodes,omitempty"`

	// Template configuration for VM cloning
	Template Template `json:"template,omitempty"`

	// CredentialsRef is a reference to a Secret with Proxmox credentials
	// +optional
