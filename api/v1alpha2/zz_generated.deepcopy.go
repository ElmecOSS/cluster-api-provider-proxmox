...
func (in *ClusterSettings) DeepCopyInto(out *ClusterSettings) {
	*out = *in
	if in.Instances != nil {
		...
		*out = make([]ProxmoxInstance, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxmoxInstance) DeepCopyInto(out *ProxmoxInstance) {
	*out = *in
	if in.Nodes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxmoxInstance.
func (in *ProxmoxInstance) DeepCopy() *ProxmoxInstance {
	if in == nil {
		return nil
	}
	out := new(ProxmoxInstance)
	in.DeepCopyInto(out)
	return out
}
